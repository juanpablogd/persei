...
$(document).ready(function() {
	localStorage.removeItem("geometria");
	...
	$("#Guardar").click(function(){
	    ...
	    var gps =map.getLayersByName("Posicion");
	    //console.log(gps[0].features.length);
	    if(gps[0].features.length>0){
            if(layerdibujo[0].features.length==1){
                if( localStorage.feature=="point"){
                    var distancia=gps[0].features[0].geometry.distanceTo(layerdibujo[0].features[0].geometry);
                    if(distancia<50){
                        var r = confirm("Seguro de guardar Geometria");
                        if (r == true) {
                        ...
                        alert("La úbicacion del GPS a la geometria , No puede Superar los 50 mt");    
                    }
                }else{
                    var r = confirm("Seguro de guardar Geometria");
                    if (r == true) {
